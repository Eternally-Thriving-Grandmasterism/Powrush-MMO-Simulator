...
//#region node_modules/.nitro/vite/services/ssr/assets/router-4kzUBzRM.js
var router_4kzUBzRM_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DaOyDIOa.css";
var APP_NAME = "Powrush";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Powrush — mercy-gated resource-based economy MMO. Harvest, epiphany, and PATSAGi council trials."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
var $$splitComponentImporter = () => import("./routes-BfvC1dkl.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_4kzUBzRM_exports as t };
